        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("livre", "livre para todos"), ("adulto", "adulto")],
                        max_length=45,
                        null=True,
                    ),
                ),
                (
                    "banner",
                    models.ImageField(blank=True, null=True, upload_to="capas/"),
                ),
                (
                    "autores",
                    models.ManyToManyField(
                        blank=True, related_name="livro", to="core.autor"
                    ),
                ),
                (
                    "categoria",
